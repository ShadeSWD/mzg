...
(function () {
  ...
  function reset() {
    ...
    $('v3hint').textContent = 'Виртуальные данные очищены — на странице действуют учебный пример. Режим снова можно менять.';
  }
  ...
  function render() {
    ...
    /* решение по шагам — тот же формат, что и в исходной части */
    ...
    $('v3hint').textContent = locked
      ? `Режим зафиксирован (${$('v3r').value} %) на время серии — «вернуть учебный пример» разблокирует его. Снято сечений: ${rs.length} из 6.`
